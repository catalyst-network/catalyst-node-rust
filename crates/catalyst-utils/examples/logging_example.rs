...
fn main() -> CatalystResult<()> {
    ...
    patterns::log_transaction(&logger, "tx_abc123", "confirmed", Some(1000))?;
    ...
    patterns::log_network_event(
        ...
        Some({
            ...
            details.insert(
                ...
                LogValue::String("192.168.1.100".to_string()),
            );
    ...
    let advanced_fields = vec![
        ...
        (
            "from_address",
            LogValue::String("0x1234...5678".to_string()),
        ),
        ...
        (
            "signature",
            LogValue::Bytes(vec![0x01, 0x23, 0x45, 0x67, 0x89, 0xab]),
        ),
    ];
    ...
    filtered_logger.error(
        LogCategory::System,
        "This error won't appear (wrong category)",
    )?;
    ...
    let error_fields = vec![
        ...
        (
            "error_message",
            LogValue::String("Timeout waiting for votes".to_string()),
        ),
